...
(define-syntax-rule (collection-cdr s) (stream-rest s))

(define-syntax-rule (collection-car s) (stream-first s))

(define-syntax-rule (collection-empty? s) (stream-empty? s))

(define (collection-filter a b) (stream-filter a b))

(define (collection-map a b) (stream-map a b))

(define (collection-empty-stream) (empty-stream))